...
Puede acceder a https://library.netapp.com/ecm/ecm_download_file/ECMLP2882082["Notas de la versión de ONTAP Select 9.11.1"^] para ver los detalles acerca de la versión actual.
